...
namespace ADAM.DataAccess.Data
{
    public class ApplicationDbContext : IdentityDbContext<IdentityUser>
    {
        ...
        {
            base.OnModelCreating(modelBuilder);  //after using IdentityDbContext : It's  because keys of identity tables are mapped in the OnModelCreating, and if this particular method is not called then you will run into the error message.
