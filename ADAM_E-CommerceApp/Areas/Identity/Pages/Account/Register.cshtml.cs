...
namespace ADAM_E_CommerceApp.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        {
            //create roles in database if not exist
            ...
            Input = new()
            {
                ...
                /* we cannot use Value as i.Id as in out Input Model, we don't have property RoleId,
